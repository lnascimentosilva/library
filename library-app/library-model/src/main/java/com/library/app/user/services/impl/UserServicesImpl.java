...
public class UserServicesImpl implements UserServices {
	...
	@Override
	public void update(final User user) throws FieldNotValidException, UserExistentException, UserNotFoundException {
	...
	@Override
	public void updatePassword(final Long id, final String password) throws UserNotFoundException {
	...
	@Override
	public User findByEmailAndPassword(final String email, final String password) throws UserNotFoundException {
